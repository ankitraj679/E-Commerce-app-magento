...
import { Languages, Styles, Color, Constants, Tools, GoogleAnalytics } from "@common";
  ...
  renderButtonGroup() {
    ...
    const opAddToWishlist = () => {
      ...
      if (this.isInWishList) {
        GoogleAnalytics.strackEvent("WishList", "Remove", "Remove wish list item", 1);
        this.props.removeWishListItem(_product, _variation);
      } else {
        GoogleAnalytics.strackEvent("WishList", "Add", "Add wish list item", 2);
