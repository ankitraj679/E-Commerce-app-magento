...
export default class Index extends Component {
  ...
  render() {
    ...
    // log(getHTML());
    const jsCode = "jQuery('header, footer, .main-header.sticky-menu, .c27-top-content-margin, .woocommerce-tabs.wc-tabs-wrapper, section.related.products').css('display', 'none')";
