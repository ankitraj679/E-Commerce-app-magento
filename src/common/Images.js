...
const Images = {
  ...
  IconCardBack: require("@images/card/card-back.png"),
  IconCardFront: require("@images/card/card-front.png"),
  IconArrowDown: require("@images/checkout/ic_arrow_drop_down.png"),
  IconArrowRight: require("@images/checkout/ic_arrow_right.png"),
};
